  ...
  return (
    <div className="relative bg-primary-grey w-full h-screen flex flex-col lg:flex-row items-center justify-center px-4 sm:px-8 md:px-12">
      <div className="lg:w-1/2 p-4 lg:p-8">
        <h1 className="text-yellow-400 font-lora font-medium tracking-widest text-left text-3xl sm:text-4xl md:text-5xl lg:text-6xl transition-all duration-300 ease-in-out">
      ...
      <div className="lg:w-1/2 p-4 lg:p-8">
        <p className="text-white font-akzidenz font-light tracking-widest text-left text-sm sm:text-base md:text-lg lg:text-xl transition-all duration-300 ease-in-out">
